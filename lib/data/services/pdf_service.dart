...
class PdfService implements IPdfService {
  ...
  Future<Uint8List> gerarPdfOrcamentoBytes({
    ...
    final dadosEmpresa = await _firestoreService.pegarDadosEmpresa();
    ...
    final diasValidade = dadosEmpresa?['validade_orcamento'] ?? 15;
    final corHex = dadosEmpresa?['cor_pdf'] ?? '0xFF448AFF';
    final corDestaque = PdfColor.fromInt(int.parse(corHex));
    final nomeEmpresa = dadosEmpresa?['nome_empresa'] ?? 'Minha Empresa';
    ...
    final totalGeral = itens.fold(0.0, (soma, item) => soma + item.total);
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Row(
                    ...
                    children: [
                      ...
                      pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.end,
                        children: [
                          pw.Text('DATA: ${formatadorData.format(dataHoje)}'),
                          pw.Text(
                  ...
                  pw.Text(
                    'INFORMAÇÕES DO SERVIÇO A SER EXECUTADO:',
                    style: pw.TextStyle(
                      fontWeight: pw.FontWeight.bold,
                      fontSize: 10,
                      color: corDestaque,
                  ...
                  pw.Text(
                    nomeObra.isEmpty ? 'Não especificado' : nomeObra,
                    style: pw.TextStyle(
                      fontWeight: pw.FontWeight.bold,
                      fontSize: 12,
                    ),
            ...
            pw.Center(
              child: pw.Text(
                'Orçamento gerado via App Orça Sim.',
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    formatadorMoeda.format(totalFaturado),
                    style: pw.TextStyle(
                      fontWeight: pw.FontWeight.bold,
